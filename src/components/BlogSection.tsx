        ...
        <div className="space-y-12 bg-[#FDFCFB]">
          ...
          <div className="text-center space-y-3.5 max-w-xl mx-auto">
            <div className="flex items-center justify-center gap-2 text-[#6B705C]">
              ...
              <span className="text-[10px] uppercase font-bold tracking-[0.25em]">Botanical Apothecary Logs</span>
            </div>
            ...
            <p className="text-xs text-[#6B705C] leading-relaxed font-semibold italic">
              Explore scientific phytic insights, clean formulations guides, and ancient sensory calming rituals written by Latam Natural's dermatological concierges.
            </p>
          </div>
