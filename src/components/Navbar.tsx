  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-[#FDFCFB]/95 backdrop-blur-md border-b border-[#E5E5E5] transition-all">
      ...
      <div className="w-full bg-[#1A1A1A] text-[#FDFCFB] text-[10px] tracking-[0.2em] py-2 px-4 text-center font-sans uppercase">
        Complimentary Ritual Discovery Gift with Orders above $75 • Use: <span className="font-semibold text-orange-400">WELLNESS10</span>
      </div>
          ...
          <div className="flex items-center space-x-6">
            ...
            {user && (
              ...
              >
                ...
                <span className="font-medium tracking-wide">{user.loyaltyPoints} Royalty Points</span>
              </div>
            )}
            ...
            <button
              ...
              title="View Wishlist inside Apothecary"
            >
