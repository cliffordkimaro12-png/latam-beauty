      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-stone-200 pb-5 mb-8">
        <div>
          <div className="flex items-center gap-2 text-emerald-800">
            ...
            <span className="text-[11px] uppercase tracking-widest font-bold">Latam Natural Administrator Command Base</span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="p-5 bg-white border border-stone-200 shadow-sm flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="font-serif text-2xl font-bold text-stone-900">${stats.totalRev.toFixed(2)}</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="p-6 bg-white border border-stone-200 shadow-sm space-y-4">
              ...
              <p className="text-xs text-stone-500 leading-relaxed">
                The core tracking engine monitors registered wellness seekers who have initiated a profile but haven't placed an order within 48 hours. Launch newsletter follow-ups with WELLNESS10 coupons:
              </p>
      ...
      {tab === 'products' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 font-sans">
          ...
          <div className="lg:col-span-5 bg-white border border-stone-200 p-6 shadow-sm space-y-4">
            ...
            <form onSubmit={handleSaveProduct} className="space-y-4 text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[10px] uppercase font-bold text-stone-600 mb-1">Price ($)</label>
                  <input
                    type="number"
                    required
                    value={price}
          ...
          <div className="lg:col-span-7 bg-white border border-stone-200 p-6 shadow-sm space-y-4">
            <h3 className="font-serif text-[17px] font-semibold text-stone-900 uppercase">Existing Apothecary Catalog</h3>
                ...
                <div key={p.id} className="p-3 bg-stone-50/50 border border-stone-200 flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-mono text-[10.5px] text-stone-500">${p.price.toFixed(2)} • {p.stock} in stock</p>
                    </div>
                  </div>
              ...
              <tbody className="divide-y divide-neutral-100">
                {allOrders.map((ord) => (
                  <tr key={ord.id} className="hover:bg-stone-50/40 text-[12px]">
                    ...
                    <td className="p-3 font-bold text-[#1c1917]">${ord.total.toFixed(2)}</td>
                    <td className="p-3">
            ...
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="border-b border-stone-200 bg-stone-50 uppercase tracking-wider text-[10px] text-[#78716c]">
                  ...
                  <th className="p-3">Royalty Balance</th>
