    ...
    <div className="bg-[#FDFCFB] p-6.5 border border-[#E5E5E5] max-w-5xl mx-auto my-12 rounded-none">
      ...
      {productsToCompare.length === 0 ? (
        <div className="text-center py-12 space-y-3 font-sans">
          ...
          <p className="text-[10px] text-[#A8A29E] uppercase tracking-wider font-semibold">Touch the "Compare Profile" trigger on apothecary items to view side-by-side specs</p>
        </div>
      ) : (
