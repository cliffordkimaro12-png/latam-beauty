              ...
              {success ? (
                <div className="p-5 bg-emerald-50 border border-emerald-250 font-sans text-center space-y-3">
                  ...
                  <p className="text-xs text-emerald-900 leading-relaxed">
                    Hello {name || 'Seeker'}, your dossier has been compiled and catalogued. Latam Natural's leadership concierges typically audit applications within 4 business days.
                  </p>
                  <button
                ...
                <form onSubmit={handleApply} className="space-y-4 text-xs">
                  ...
                  <div>
                    <label className="block text-[10px] uppercase tracking-wider text-stone-500 mb-1">Latam Natural Statement of Purpose / Experience</label>
                    <div className="relative">
