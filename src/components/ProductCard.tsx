...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className="group relative bg-[#FDFCFB] border border-[#E5E5E5] overflow-hidden flex flex-col justify-between h-full hover:shadow-lg transition-all duration-300">
      ...
      <div className="relative aspect-square w-full bg-[#F5F2ED] overflow-hidden cursor-pointer animate-fade-in" onClick={onViewDetails}>
        ...
        {product.stock <= 5 && (
          <span className="absolute bottom-3 left-3 bg-red-50 text-red-900 border border-red-200 px-2 py-1 text-[8px] font-bold tracking-widest uppercase rounded-none">
            {product.stock === 0 ? 'Out of Stock' : `Hurry: Only ${product.stock} Left`}
          </span>
        )}
        ...
        <div>
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <span>{isCompareChecked ? 'Added to Compare' : 'Compare Profile'}</span>
            </button>
