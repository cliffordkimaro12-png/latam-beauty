  ...
  const handleToggleCompare = (product: Product) => {
    ...
    if (index > -1) {
      ...
      if (compareList.length >= 3) {
        alert('You may only review up to three botanical variations side-by-side.');
        return;
      }
          ...
          <div className="space-y-16">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <h3 className="font-serif text-xl font-light uppercase tracking-[0.2em] text-[#1A1A1A] text-center mb-8">
                Complimentary Apothecary Gifts
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-6 bg-[#FDFCFB] border border-[#E5E5E5] text-center space-y-2.5 rounded-none relative overflow-hidden transition-shadow hover:shadow-md animate-fade-in">
                  ...
                  <h4 className="font-serif tracking-wide font-medium text-[15px] text-[#1A1A1A]">10% Circle Gift</h4>
                  <p className="text-xs text-[#6B705C] font-semibold">Enjoy 10% reduction off organic elixirs.</p>
                  <span className="inline-block font-mono text-[11px] font-bold bg-[#F5F2ED] px-4 py-1.5 border border-[#E5E5E5] rounded-none uppercase mt-2.5 text-[#1A1A1A] tracking-wider">WELLNESS10</span>
                </div>

                <div className="p-6 bg-[#FDFCFB] border border-[#E5E5E5] text-center space-y-2.5 rounded-none relative overflow-hidden transition-shadow hover:shadow-md animate-fade-in">
                  <div className="absolute top-0 right-0 w-12 h-12 bg-[#F5F2ED] rounded-bl-full pointer-events-none" />
                  <Sparkles className="w-5 h-5 text-[#6B705C] mx-auto" />
                  <h4 className="font-serif tracking-wide font-medium text-[15px] text-[#1A1A1A]">20% High-Spend Reward</h4>
                  <p className="text-xs text-[#6B705C] font-semibold">20% off restorative items (min spend $100).</p>
                  <span className="inline-block font-mono text-[11px] font-bold bg-[#F5F2ED] px-4 py-1.5 border border-[#E5E5E5] rounded-none uppercase mt-2.5 text-[#1A1A1A] tracking-wider">AURA20</span>
                </div>

                <div className="p-6 bg-[#FDFCFB] border border-[#E5E5E5] text-center space-y-2.5 rounded-none relative overflow-hidden transition-shadow hover:shadow-md animate-fade-in">
                  <div className="absolute top-0 right-0 w-12 h-12 bg-[#F5F2ED] rounded-bl-full pointer-events-none" />
                  <Clock className="w-5 h-5 text-[#6B705C] mx-auto" />
                  <h4 className="font-serif tracking-wide font-medium text-[15px] text-[#1A1A1A]">Royalty Rewards Unlocked</h4>
                  <p className="text-xs text-[#6B705C] font-semibold">Earn 1 point per $1 spent, redeem for cash off.</p>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
              <div className="flex flex-col md:flex-row justify-between items-center mb-10 pb-4 border-b border-[#E5E5E5]">
                <div className="text-center md:text-left space-y-1">
                  <h3 className="font-serif text-2xl uppercase tracking-[0.12em] text-stone-900 font-light">Bestselling Botanical Complexes</h3>
                  <p className="text-[11px] text-[#6B705C] uppercase tracking-[0.2em] font-bold">Formulated to support dermal restore cycles</p>
                </div>
                <button
                ...
                >
                  <span>Browse Full Apothecary</span>
            ...
            <section className="bg-[#FDFCFB] border-y border-[#E5E5E5] py-20 text-center">
              <div className="max-w-4xl mx-auto px-4 space-y-6">
                ...
                <blockquote className="font-serif text-lg sm:text-xl md:text-2xl font-light italic tracking-wide text-[#1A1A1A] leading-relaxed">
                  "I was deeply skeptical about switching from my premium luxury brand to native organic elixirs. But Latam Natural’s Botanical Radiance Serum completely revitalized my facial moisture barrier, reducing fine tissue redness. The aromatherapy sandalwood roller is my sacred evening escape."
                </blockquote>
                <div className="space-y-1.5">
                  <cite className="font-serif text-sm font-medium not-italic text-stone-900">Theresa Westwood — Beverly Hills Club</cite>
                  <span className="text-[9px] text-[#6B705C] uppercase tracking-[0.2em] block font-bold">Verified Seeker of Latam Natural</span>
                </div>
              </div>
            </section>
          </div>
        ...
        {currentView === 'shop' && (
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
            ...
            <div className="text-center space-y-2 max-w-xl mx-auto pb-4">
              <span className="text-[10px] uppercase font-bold text-[#6B705C] tracking-[0.25em]">NATURAL REMEDIES FOR INTELLIGENT CARE</span>
              <h1 className="font-serif text-3xl uppercase tracking-[0.12em] font-light text-stone-950">The Apothecary Catalogue</h1>
              <p className="text-xs text-[#6B705C] font-semibold italic leading-relaxed">
                Filter by segment or target focus. Discover premium, certified organic, non-gmo formulations optimized to repair, soothe, and vitalize.
              </p>
            </div>
            ...
            <div className="p-4.5 bg-white border border-[#E5E5E5] shadow-sm flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-sans rounded-none">
              ...
              <div className="flex flex-wrap gap-1.5">
                {['All', 'Skincare', 'Aromatherapy', 'Haircare', 'Herbal Teas'].map((cat) => (
                  <button
                    key={cat}
            ...
            {compareList.length > 0 && (
              <div className="p-3 bg-teal-50 border border-teal-200 flex items-center justify-between text-xs font-sans rounded">
                <span className="font-semibold text-teal-980">
                  You added {compareList.length} botanical profiles candidate. Review side-by-side specs:
                </span>
            ...
            {filteredProducts.length === 0 ? (
              <div className="text-center py-20 bg-white border border-stone-200">
                ...
                <p className="font-serif italic text-base text-[#78716c]">No botanical solutions correspond to your query.</p>
            ...
            <div className="bg-[#FDFCFB] border border-[#E5E5E5] p-6.5 flex flex-col md:flex-row justify-between items-center gap-6 shadow-sm rounded-none">
              <div className="text-center md:text-left space-y-1">
                ...
                <h2 className="font-serif text-2xl font-light text-stone-900 uppercase tracking-wide">
                  Welcome to Your Sanctuary, {user.name}
                </h2>
              ...
              <div className="px-5 py-4 bg-[#F5F2ED] rounded-none border border-[#E5E5E5] text-center space-y-1">
                ...
                <p className="text-[10px] text-stone-500 italic font-medium">Valid value: ${((user.loyaltyPoints || 0)/100*5).toFixed(2)} off next order</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-7 bg-[#FDFCFB] border border-[#E5E5E5] p-6 shadow-sm space-y-4 rounded-none">
                ...
                <div className="space-y-4 max-h-[500px] overflow-y-auto pr-1">
                  {orders.length === 0 ? (
                    <p className="text-xs text-[#6B705C] italic">No botanical transactions completed yet. Browse Apothecary to complete your first ritual.</p>
                  ) : (
                    orders.map((ord) => (
                      <div key={ord.id} className="p-4.5 bg-[#FDFCFB] border border-[#E5E5E5] relative text-xs space-y-3 shadow-sm rounded-none">
                        ...
                        <div className="border-y border-[#E5E5E5] py-2.5 space-y-1.5">
                          {ord.items.map((item, id) => (
                            <div key={id} className="flex justify-between font-medium">
                              ...
                              <span className="font-serif font-semibold text-[#1A1A1A]">${(item.price * item.quantity).toFixed(2)}</span>
                            </div>
                          ))}
                        </div>
                        ...
                        <div className="flex justify-between items-center pt-1">
                          ...
                          <span className="font-serif font-bold text-base text-[#1A1A1A]">
                            Total Charged: ${ord.total.toFixed(2)}
                          </span>
                        </div>
      ...
      <footer className="bg-[#1A1A1A] text-[#999999] pt-16 pb-10 border-t border-[#D4CFC9]/25 font-sans text-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-stone-800">
          ...
          <div className="space-y-4">
            <h4 className="font-serif text-[#FDFCFB] uppercase tracking-[0.25em] font-medium text-sm">LATAM NATURAL</h4>
            <p className="leading-relaxed text-[#999999]/90 font-light text-[12.5px]">
              Pristine cellular phytoremediation synthesizes highly balanced biological compounds from cold-pressed native seed extracts. Cultivated with supreme aesthetic rigor.
            </p>
          ...
          <div className="space-y-4">
            <h4 className="font-serif text-[#FDFCFB] uppercase tracking-[0.2em] font-medium">The Apothecary Segments</h4>
            <ul className="space-y-2.5 text-[#999999]/85 font-medium">
              <li><button onClick={() => { setView('shop'); setCategoryFilter('Skincare'); }} className="hover:text-[#FDFCFB] transition-colors cursor-pointer">Youth Elixir Skincare</button></li>
              <li><button onClick={() => { setView('shop'); setCategoryFilter('Aromatherapy'); }} className="hover:text-[#FDFCFB] transition-colors cursor-pointer">Restorative Aromatherapy</button></li>
              <li><button onClick={() => { setView('shop'); setCategoryFilter('Haircare'); }} className="hover:text-[#FDFCFB] transition-colors cursor-pointer">Organic Minerals Haircare</button></li>
              <li><button onClick={() => { setView('shop'); setCategoryFilter('Herbal Teas'); }} className="hover:text-[#FDFCFB] transition-colors cursor-pointer">Blue Lotus Imperial Teas</button></li>
            </ul>
          </div>

          <div className="space-y-4">
            <h4 className="font-serif text-[#FDFCFB] uppercase tracking-[0.2em] font-medium">Sanctuary Sovereignty</h4>
            <ul className="space-y-2.5 text-[#999999]/85 font-medium">
              ...
              <li><button onClick={() => { if(user) setView('profile'); else setIsAuthOpen(true); }} className="hover:text-[#FDFCFB] transition-colors cursor-pointer">Royalty Member Space</button></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-[#999999]/85 leading-relaxed font-medium">
              Suite 4A, Beverly Wellness Row, CA<br />
              Secure Telex: +1 (800) 555-AURA<br />
              Encryption Mail: support@latamnatural.com
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 flex flex-col sm:flex-row justify-between items-center text-[10px] text-[#999999]/70 font-semibold tracking-[0.1em] uppercase">
          <p>© 2026 Latam Natural &amp; Wellness. End-to-End Encryption Sealed. All Rights Reserved.</p>
      ...
      {isCartOpen && (
        <CartDrawer
          ...
          onCheckoutComplete={(orderData) => {
            ...
            setView('profile');
            alert(`Purchase complete, elegant Seeker! Order ID: ${orderData.id}. Saved to your personal dashboard and 100% of your royalty points recalculated!`);
          }}
        />
      )}
